...
func (m InitWizardModel) saveConfig() tea.Cmd {
	return func() tea.Msg {
		...
		content.WriteString("# spinup Configuration\n")
		content.WriteString("# Generated by spinup init\n")
...
func (m InitWizardModel) renderHeader() string {
	...
	title := titleStyle.Render("spinup setup")
...
func (m InitWizardModel) renderComplete() string {
	...
	b.WriteString("\n")
	b.WriteString("  1. Run ")
	b.WriteString(Styles.Highlighted.Render("spinup"))
